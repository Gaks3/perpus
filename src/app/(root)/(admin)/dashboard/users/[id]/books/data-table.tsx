...
import DialogAddBook from '@/components/borrow/DialogAddBook'
...
export function DataTable<TData, TValue>({
  ...
  const [searchBy, setSearchBy] = useState('book_title')
  ...
  return (
    <ScrollArea className='sm:w-[93vw] md:w-full'>
